        ...
        >
          {items.length > 0 ? (
                ...
                <li key={item.id}>
                  ...
                  >
                    <div className="mb-2 flex items-center justify-between gap-3">
                      ...
                      <span className="shrink-0 rounded-full bg-amber-200/70 px-2 py-0.5 text-[11px] font-semibold tabular-nums text-amber-950 dark:bg-amber-400/20 dark:text-amber-50">
                        {item.pageLabel}
                      </span>
                    </div>
            ...
            <div className="flex min-h-56 flex-col items-center justify-center rounded-2xl border border-dashed border-zinc-200 px-8 text-center dark:border-zinc-800">
              <Bookmark className="mb-3 size-5 text-zinc-400 dark:text-zinc-600" strokeWidth={1.8} />
